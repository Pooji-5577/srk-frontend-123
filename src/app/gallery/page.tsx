    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="pt-0">
        ...
        <div className="bg-gradient-to-r from-blue-600 to-blue-800 text-white py-12 md:py-16">
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              <Camera className="w-12 h-12 md:w-16 md:h-16 mx-auto mb-4 md:mb-6 text-blue-200" />
              <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-4 md:mb-6">
                SRKE Educational Gallery
              </h1>
              <p className="text-lg sm:text-xl md:text-2xl text-blue-100 mb-6 md:mb-8 px-4">
                Capturing moments of learning, growth, and community engagement
              </p>
              <div className="flex flex-wrap justify-center gap-2 md:gap-4 text-xs md:text-sm px-4">
                <span className="bg-blue-500 px-3 py-1.5 md:px-4 md:py-2 rounded-full flex items-center gap-1 md:gap-2">
                  <Camera className="w-3 h-3 md:w-4 md:h-4" />
                  {galleryImages.length} Photos
                </span>
                <span className="bg-green-500 px-3 py-1.5 md:px-4 md:py-2 rounded-full">Educational Activities</span>
                <span className="bg-orange-500 px-3 py-1.5 md:px-4 md:py-2 rounded-full">Community Events</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4 py-6 md:py-8">
          <div className="flex flex-wrap justify-center gap-2 md:gap-4 mb-6 md:mb-8">
            {categories.map((category) => (
              <button
                ...
                className={`px-4 py-2 md:px-6 md:py-3 rounded-full font-semibold transition-all duration-300 flex items-center gap-1 md:gap-2 text-sm md:text-base ${
              ...
              >
                ...
                {category}
                <span className="bg-blue-100 text-blue-600 text-xs px-1.5 py-0.5 md:px-2 md:py-1 rounded-full ml-1 md:ml-2">
          ...
          {/* Gallery Grid */}
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 md:gap-6">{filteredItems.map((item) => (
                ...
                <div className="p-3 md:p-4">
                  ...
                  <div className="flex items-center justify-between text-xs text-gray-500">
                    ...
                    <div className="flex items-center gap-1">
                      ...
                      <span className="hidden sm:inline">SRKE Campus</span>
                      <span className="sm:hidden">SRKE</span>
                    </div>
                  </div>
                </div>
              </div>
          ...
          {filteredItems.length === 0 && (
            <div className="text-center py-12 md:py-16">
              <Camera className="w-12 h-12 md:w-16 md:h-16 mx-auto text-gray-300 mb-4" />
              <h3 className="text-lg md:text-xl font-semibold text-gray-500 mb-2">No images found</h3>
              <p className="text-sm md:text-base text-gray-400">Try selecting a different category filter.</p>
            </div>
          )}
        </div>

        {/* Info Section */}
        <div className="bg-gradient-to-r from-blue-600 to-blue-800 text-white py-8 md:py-12 mt-12 md:mt-16">
          <div className="container mx-auto px-4 text-center">
            ...
            <div className="flex flex-wrap justify-center gap-3 md:gap-6 text-xs md:text-sm">
              <div className="flex items-center gap-1.5 md:gap-2">
                <div className="w-2.5 h-2.5 md:w-3 md:h-3 bg-blue-400 rounded-full"></div>
              ...
              <div className="flex items-center gap-1.5 md:gap-2">
                <div className="w-2.5 h-2.5 md:w-3 md:h-3 bg-orange-400 rounded-full"></div>
